...
export const deleteTransaction = (transactionId) => axios.delete(`/transaction/${transactionId}`);

export const getIncomeCategories = () => axios.get("/transaction/income-categories");

export const getExpenseCategories = () => axios.get("/transaction/expense-categories");

export const getTransactionPeriodData = (date) => axios.get(`/transaction/period-data?date=${date}`);

export const updateUserBalance = (balance) => axios.patch("/user/balance", balance);
